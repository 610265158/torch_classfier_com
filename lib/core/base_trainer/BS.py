...
class TopKDecoder():
    ...
    def __call__(self, inputs=None, encoder_hidden=None, encoder_outputs=None, function=F.log_softmax,
        ...
        self.pos_index = (torch.LongTensor(range(batch_size)) * self.k).view(-1, 1).to(self.device)
